...
public class GUICliente extends javax.swing.JFrame {
    ...
    private void initGUI() {
        try {
            ...
            }
            {
                ...
                jpanelchat.setBackground(new java.awt.Color(0, 0, 102));
    ...
    private void jButtonConecActionPerformed(ActionEvent evt) {
        ...
        //jtextareacontacto.setForeground(new java.awt.Color(51, 153, 0));
        jlabelclienteNombre.setFont(new java.awt.Font("Arial", 1, 10)); // NOI18N
        jlabelclienteNombre.setForeground(new java.awt.Color(255, 255, 255));
        jlabelclienteNombre.setText(nombre);
        try {
            servidor = (ServidorCllbckint) UtilidadesRegistroC.obtenerObjRemoto(Integer.parseInt(jtextfieldpuerto.getText()),
                    jtextfieldservidor.getText(), "ServidorUsuarios");
            nuevoUsuario = new UsuarioCllbckImpl(this);
            if (servidor.registrarUsuario(nuevoUsuario, nombre)) {
                jpanelconexion.setVisible(false);
                javax.swing.JOptionPane.showMessageDialog(this, "Conectado: " + nombre);
                jpanelchat.setVisible(true);
            } else {
                javax.swing.JOptionPane.showMessageDialog(this, "el nombre: " + nombre + " ya se encuentra registrado.");
            }
        } catch (Exception e) {
    ...
    private void jtextareamsgKeyTyped(java.awt.event.KeyEvent evt) {
    ...
    private void jbuttonenviarActionPerformed(ActionEvent evt) {
        try {
            ...
            servidor.enviarMensaje(nuevoUsuario, jtextareamsg.getText(), nombre);
